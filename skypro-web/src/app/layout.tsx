...
export const metadata: Metadata = {
  ...
  title: {
    // 56 chars — within Google's 50-60 sweet spot
    default: 'SkyPro — Marketing Automation for 18+ Platforms in 1 Click',
    template: '%s | SkyPro',
  },
  // 152 chars — within recommended 110-160 range
  description:
    'Automate your marketing on Facebook, WhatsApp, Instagram, Telegram & 14 more platforms. Extract leads, send bulk messages, manage multi-accounts. Try free.',
  keywords: [
  ...
  openGraph: {
    // Images auto-generated by src/app/opengraph-image.tsx (1200x630, Edge runtime, branded)
    // 58 chars — sweet spot for OG cards
    title: 'SkyPro — Marketing Automation for 18+ Platforms | Sky Wave',
    // 156 chars — full preview in feed cards
    description:
      'Automate marketing on Facebook, WhatsApp, Instagram, Telegram & 14+ platforms. Extract leads, send bulk campaigns, manage multi-accounts. Try free for 2 days.',
    url: SITE_URL,
  ...
  twitter: {
    // Images auto-generated by src/app/twitter-image.tsx
    card: 'summary_large_image',
    site: '@skywaveads',
    creator: '@skywaveads',
    // 56 chars
    title: 'SkyPro — Marketing Automation for 18+ Platforms in 1 Click',
    // 142 chars — fits Twitter's preview
    description:
      'Automate marketing on Facebook, WhatsApp, Instagram, Telegram & 14+ platforms. Extract leads, send bulk messages, manage accounts. Try free.',
  },
  robots: {
    index: true,
    follow: true,
  ...
  // Icons auto-generated by Next.js from src/app/icon.png + src/app/apple-icon.png.
  // Manual entries below are PWA manifest icons (different from browser favicon).
