...
export const faqs = [
  {
    question: 'ما هو SkyPro؟',
    answer: 'SkyPro هو تطبيق تسويق احترافي يعمل على 18+ منصة تواصل اجتماعي. يساعدك على أتمتة حملاتك التسويقية من استخراج البيانات والإرسال الجماعي وإدارة العملاء.'
  },
  {
  ...
  },
  {
    ...
    answer: 'SkyPro يستخدم تقنيات متقدمة: تأخير عشوائي بين العمليات، تصفح عشوائي، تبديل بصمة المتصفح، بروكسي مخصص لكل جلسة، وحدود آمنة لكل منصة.'
  },
]